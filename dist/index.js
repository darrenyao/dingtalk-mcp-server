...
const client_js_1 = require("./dingtalk/client.js");
const auth_js_1 = require("./dingtalk/auth.js");
/**
...
class DingTalkServer {
    constructor() {
        ...
        this.auth = (0, auth_js_1.getAuth)(appKey, appSecret);
    ...
    async handleSendMessage(user, content) {
        try {
    ...
    async handleSearchUsers(query, exact_match = false) {
        try {
            await this.ensureInitialized();
            if (!this.client) {
                throw new Error('DingTalk client is not available');
    ...
    async handleGetUserInfo(user_id) {
        try {
            await this.ensureInitialized();
            if (!this.client) {
                throw new Error('DingTalk client is not available');
